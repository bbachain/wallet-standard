 ...
 * TODO: docs
 */
export function verifySignIn(input: BBAChainSignInInput, output: BBAChainSignInOutput): boolean {
    const {
        signedMessage,
        signature,
        account: { publicKey },
 ...
 * TODO: docs
 */
export function deriveSignInMessage(input: BBAChainSignInInput, output: BBAChainSignInOutput): Uint8Array | null {
 ...
 * TODO: docs
 */
export function deriveSignInMessageText(input: BBAChainSignInInput, output: BBAChainSignInOutput): string | null {
 ...
 * TODO: docs
 */
export type BBAChainSignInInputWithRequiredFields = BBAChainSignInInput &
    Required<Pick<BBAChainSignInInput, 'domain' | 'address'>>;

/**
 * TODO: docs
 */
export function parseSignInMessage(message: Uint8Array): BBAChainSignInInputWithRequiredFields | null {
 ...
 * TODO: docs
 */
export function parseSignInMessageText(text: string): BBAChainSignInInputWithRequiredFields | null {
 ...
 * TODO: docs
 */
export function createSignInMessage(input: BBAChainSignInInputWithRequiredFields): Uint8Array {
 ...
 * TODO: docs
 */
export function createSignInMessageText(input: BBAChainSignInInputWithRequiredFields): string {
    // ${domain} wants you to sign in with your BBAChain account:
    // ${address}
    //
    // ${statement}
    //
    ...
    let message = `${input.domain} wants you to sign in with your BBAChain account:\n`;
