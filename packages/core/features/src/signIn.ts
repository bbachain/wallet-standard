...
/** Name of the feature. */
export const BBAChainSignIn = 'bbachain:signIn';

/** TODO: docs */
export type BBAChainSignInFeature = {
    /** Name of the feature. */
    readonly [BBAChainSignIn]: {
        /** Version of the feature API. */
        readonly version: BBAChainSignInVersion;

        /** Sign In With BBAChain (based on https://eips.ethereum.org/EIPS/eip-4361 and https://github.com/ChainAgnostic/CAIPs/blob/master/CAIPs/caip-122.md). */
        readonly signIn: BBAChainSignInMethod;
    };
};

/** Version of the feature. */
export type BBAChainSignInVersion = '1.0.0';

/** TODO: docs */
export type BBAChainSignInMethod = (
    ...inputs: readonly BBAChainSignInInput[]
) => Promise<readonly BBAChainSignInOutput[]>;

/** Input for signing in. */
export interface BBAChainSignInInput {
    /**
...
export interface BBAChainSignInOutput {
    /**
