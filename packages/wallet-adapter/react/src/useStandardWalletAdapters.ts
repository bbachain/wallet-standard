import type { Adapter, WalletName } from '@bbachain/wallet-adapter-base';
import { isWalletAdapterCompatibleWallet, StandardWalletAdapter } from '@bbachain/wallet-standard-wallet-adapter-base';
